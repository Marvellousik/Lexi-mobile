      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        ...
        >
          ...
          <View style={styles.socialRow}>
            <TouchableOpacity style={styles.socialButton} activeOpacity={0.8} accessible={true} accessibilityLabel="Sign up with Google" accessibilityRole="button">
              <Ionicons name="logo-google" size={18} color="#3D7A52" />
              <Text style={styles.socialText}>Google</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.socialButton} activeOpacity={0.8} accessible={true} accessibilityLabel="Sign up with LinkedIn" accessibilityRole="button">
...
const styles = StyleSheet.create({
  ...
  heading: { ...text.h1, color: '#111111', marginBottom: sp['1.5'] },
  ...
  passwordInput: { flex: 1, fontSize: 16, color: '#111111' },
  button: {
    height: 52,
