...
export default function ReadingReaderScreen() {
  const c = useTheme();
  const [difficulty, setDifficulty] = useState<'simplified' | 'beginner' | 'intermediate'>('simplified');
              ...
              <View style={styles.readerHeader}>
                ...
                >
                  <Text style={styles.difficultyText}>
                    {difficulty === 'simplified' ? 'Simplified text' : difficulty.charAt(0).toUpperCase() + difficulty.slice(1)}
                  </Text>
